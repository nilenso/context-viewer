 ...
 * NO Tailwind classes, NO React.CSSProperties.
 */

// ---------------------------------------------------------------------------
// Raw hex color maps (name → hex)
// ---------------------------------------------------------------------------

/** Light background hex colors (100-level equivalent) */
...
/** Dark text hex colors (700-level equivalent, for readability) */
...
/** Waffle/chart hex colors (400/500-level, more saturated) */
