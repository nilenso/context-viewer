 ...
 * Separated from context-analyzer export-builder (pure data transforms)
 * because these use DOM APIs (Blob, createElement, click).
 */

import type { SessionExport } from "context-analyzer";
import type { PipelineState, DimensionData } from "context-analyzer";
